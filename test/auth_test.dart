...
class MockAuthProvider implements AppAuthProvider {
  ...
  @override
  AppAuthUser? get currentUser => _user;
  ...
  Future<AppAuthUser> login({
    ...
    final user = AppAuthUser(isEmailVerified: false, email: email);
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    final newUser = AppAuthUser(isEmailVerified: true, email: user.email);
    _user = newUser;
  }
}
